...
const mapStateToProps = (state) => ({
  showMridgeMethodDialog: state.measure.showMridgeMethodDialog,
});

const MridgeDialog = (props) => {
  ...
  useEffect(() => {
    setVisible(props.showMridgeMethodDialog);
    setIsTested(false);
  }, [props]);
        ...
        title={
          ...
          >
            <div className="d-flex border-bottom">
              <DialogTitle>Mridge Method</DialogTitle>
              <ToggleButtonGroup
                value={viewMode}
                exclusive
...
export default connect(mapStateToProps)(MridgeDialog);
