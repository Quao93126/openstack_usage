  ...
  return (
    <>
      <Dialog open={props.onOpen}>
        ...
        <DialogContent>
          <DialogContentText>
            In the below list, you can choose the experiment that you have
            registered already. Each experiment might include the materials of
            image source/data
          </DialogContentText>
          <List sx={{ pt: 0 }} style={{ padding: '20px 0px' }}>
            {experiment_names.map((experiment_name) => (
              <ListItem
                ...
                button
                onClick={() => handleListItemClick(experiment_name)}
                key={experiment_name}
              >
                <ListItemIcon>
                  <InboxIcon />
            ...
            <ListItem
              ...
              autoFocus
              button
              onClick={() => handleAddNewExperimentClick()}
            >
              <ListItemIcon>
                <FolderIcon />
              </ListItemIcon>
